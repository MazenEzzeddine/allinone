...
public class ConsumerThread2 implements Runnable {
    ...
    public void run() {
      ...
      /*  props.put(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG,
        ...
        consumer.subscribe(Collections.singletonList(config.getTopic()), new RebalanceTiming());
    ...
    private static void initPrometheus() {
        ...
        latencygauge = Gauge.builder("latencygauge", latencygaugemeasure, TimeMeasure::getDuration).register(prometheusRegistry);
    }
